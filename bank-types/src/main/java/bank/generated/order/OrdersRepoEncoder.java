...
public final class OrdersRepoEncoder implements MessageEncoderFlyweight
{
    ...
    private final OrdersRepoEncoder parentMessage = this;
    ...
    public OrdersRepoEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public OrdersRepoEncoder wrapAndApplyHeader(
    ...
    public OrdersRepoEncoder size(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final OrdersRepoDecoder decoder = new OrdersRepoDecoder();

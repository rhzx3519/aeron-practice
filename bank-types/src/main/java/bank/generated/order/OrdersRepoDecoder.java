...
public final class OrdersRepoDecoder implements MessageDecoderFlyweight
{
    ...
    private final OrdersRepoDecoder parentMessage = this;
    ...
    public OrdersRepoDecoder wrapAndApplyHeader(
        final DirectBuffer buffer,
        final int offset,
    ...
    public OrdersRepoDecoder sbeRewind()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        builder.append("[OrdersRepo](sbeTemplateId=");
